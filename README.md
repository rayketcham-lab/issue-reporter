...
```html
<script src="https://cdn.jsdelivr.net/gh/rayketcham-lab/issue-reporter@v2.0.2/issue-reporter.js"></script>
<script>
  IssueReporter.init({
    github: {
...
```bash
curl -O https://raw.githubusercontent.com/rayketcham-lab/issue-reporter/v2.0.2/issue-reporter.js
```
